...
Thanks for using apisguru! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/jonthegeek/apisguru/issues/new).
...
requests](https://github.com/jonthegeek/apisguru/issues) to make sure
